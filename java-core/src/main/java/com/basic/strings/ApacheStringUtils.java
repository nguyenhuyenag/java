 ...
 *
 * - firstNonEmpty, firstNonBlank: Trả về phần tử đầu tiên khác empty hoặc blank (khoảng trắng)
 *
...
public class ApacheStringUtils {
    ...
    /**
     * isAnyEmpty: Có ít nhất 1 phần tử là empty (null hoặc "")
     */
    public static void isAnyEmpty() {
        boolean isAnyEmpty = StringUtils.isAnyEmpty("", null, "AA");
        System.out.println("IsAnyEmpty: " + isAnyEmpty);
    }

    /**
     * isNoneEmpty: Có ít nhất 1 phần tử không phải là khoảng trắng
     */
    public static void isNoneBlank() {
        boolean isNoneBlank = StringUtils.isNoneBlank("", null, "AA");
