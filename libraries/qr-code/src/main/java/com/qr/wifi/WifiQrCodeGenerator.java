...
public class WifiQrCodeGenerator {
	...
	public void generateQrCodePicture() throws Exception {
		QRCodeWriter qrCodeWriter = new QRCodeWriter();
		Map<EncodeHintType, ErrorCorrectionLevel> hints = new EnumMap<>(EncodeHintType.class);
		hints.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.H);
		BitMatrix bitMatrix = qrCodeWriter.encode(getPaylodString(), BarcodeFormat.QR_CODE, QR_CODE_SIZE, QR_CODE_SIZE,
				hints);
	...
	protected String getPaylodString() {
		...
		payloadBuilder.append(QR_WIFI) //
				.append(SEPARATOR_VALUE) //
				.append(QR_WIFI_AUTHENTICATION_TYP) //
				.append(SEPARATOR_VALUE) //
				...
				.append(ssid) //
				.append(SEPARATOR_FIELD) //
				.append(QR_WIFI_PASSWORD) //
				.append(SEPARATOR_VALUE) //
				.append(StringUtils.isNotEmpty(password) ? password : "") //
				.append(SEPARATOR_FIELD)
